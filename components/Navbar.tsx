        ...
        <div className="px-6 flex justify-between items-center relative">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <a 
              ...
              className="ml-4 px-6 py-2 rounded-xl bg-primary text-white font-black text-[9px] tracking-[0.2em] uppercase hover:scale-105 transition-all active:scale-95 shadow-[0_0_20px_rgba(99,102,241,0.3)]"
            >
              PROJETAR
            </a>
          </div>
