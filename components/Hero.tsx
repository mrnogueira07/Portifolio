    ...
    <section id="home" className="relative min-h-screen flex items-center pt-32 pb-24 lg:pb-32 overflow-x-hidden bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative block animate-scale-in delay-200 mt-4 lg:-mt-16 flex justify-center lg:justify-end">
            <div className="relative group z-10 rotating-border-container p-[1px] shadow-[0_50px_100px_rgba(0,0,0,0.5)] animate-float max-w-[320px] lg:max-w-[400px]">
              ...
              <div className="relative z-10 rounded-[1.4rem] overflow-hidden bg-[#050508] p-1">
                 <img 
                  ...
                  className="rounded-[1.2rem] w-full h-auto object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 transform group-hover:scale-[1.05]"
                />
            ...
            <div className="absolute -bottom-6 -left-4 lg:left-0 z-30 glass-card p-5 rounded-2xl flex items-center gap-4 animate-slide-right delay-500 shadow-2xl border border-white/10 hover:scale-105 transition-transform cursor-default bg-[#050508]/90">
